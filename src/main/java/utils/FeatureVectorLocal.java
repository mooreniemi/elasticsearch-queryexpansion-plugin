 ...
 *
 */
public class FeatureVectorLocal {
    ...
    // CONSTRUCTORS
    public FeatureVectorLocal(String text, Stopper stopper) {
    ...
    public FeatureVectorLocal(Stopper stopper) {
        this.stopper = stopper;
        if(stopper==null || stopper.asSet().size()==0) {
            analyzer = new StandardAnalyzer();
        } else {
    ...
    public static FeatureVectorLocal interpolate(FeatureVectorLocal x, FeatureVectorLocal y, double xWeight) {
        FeatureVectorLocal z = new FeatureVectorLocal(null);
    ...
    public FeatureVectorLocal deepCopy() {
        FeatureVectorLocal copy = new FeatureVectorLocal(null);
    ...
    public static void main(String[] args) {
        ...
        FeatureVectorLocal featureVectorLocal = new FeatureVectorLocal(text, stopper);
        System.out.println(featureVectorLocal.getFeatureCount());
        featureVectorLocal.clip(5);
        System.out.println(featureVectorLocal.getFeatureCount());
    }
