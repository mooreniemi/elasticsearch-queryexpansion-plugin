package org.nationaldataservice.rocchio.test.unit;
...
import org.nationaldataservice.rocchio.Rocchio;
...
public class RocchioTest {
	...
	public void testExpandQuery() throws IOException {
		// Expand the query
		FeatureVectorLocal feedbackQuery = rocchio.expandQuery(TEST_QUERY, TEST_FB_DOCS, TEST_FB_TERMS);
