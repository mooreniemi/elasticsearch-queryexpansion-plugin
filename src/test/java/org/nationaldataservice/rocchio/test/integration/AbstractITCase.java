package org.nationaldataservice.rocchio.test.integration;
...
public abstract class AbstractITCase {
	...
	protected static XContentParser createParser(XContent xContent, InputStream data) throws IOException {
		return xContent.createParser(xContentRegistry(), DeprecationHandler.THROW_UNSUPPORTED_OPERATION, data);
	}
